...
#define BOOST_TEST_MODULE MultiCompactUnit
#include <boost/test/unit_test.hpp>

#include "MultiCompactTest.hpp"



BOOST_AUTO_TEST_CASE( multi_test_100000_42_1_1_01 )
{
    Test test( 100000, 42, true, true, 0.1f );
    test.run();
}

BOOST_AUTO_TEST_CASE( multi_test_5000000_42_1_1_01 )
{
